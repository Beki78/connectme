    ...
    >
      ...
      <div className="overflow-y-scroll h-64 mb-4 border border-gray-300 p-4 bg-gray-100 dark:bg-gray-900 rounded-lg">
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">
          ...
          the following terms and conditions. These terms apply to all users and
          visitors who access or use the service.
        </p>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">
          Our service allows you to create a profile page where you can link to
          your social media accounts and other online platforms. You agree not
          to use the service for any unlawful or prohibited activities,
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">
          ...
          provide and improve our services, including your name, email address,
          and linked social media profiles. We do not sell your data to third
          parties.
        </p>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">
          ...
          However, we cannot guarantee absolute security. You are responsible
          for keeping your account information, including your password,
          confidential.
        </p>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">
          ...
          and will remain the exclusive property of our company. You may not
          duplicate, copy, or reuse any portion of the service without our
